								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7"> {{ App\Models\Invoices::where('value_status','=',2)->count()}} فاتورة</span>
										</span>
									</div>
								</div>
							</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7"> {{ App\Models\Invoices::where('value_status','=',1)->count() }} فاتورة</span>
										</span>
									</div>
								</div>
							</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7"> {{ App\Models\Invoices::where('value_status','=',3)->count() }} </span>
										</span>
									</div>
								</div>
							</div>
